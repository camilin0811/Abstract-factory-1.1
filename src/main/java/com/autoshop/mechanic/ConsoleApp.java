...
/**
 * Interactive text console front-end for the shop. The user picks a
 * vehicle family and types in the reported symptoms; the corresponding
 * VehicleFactory is built and the AI diagnosis runs live against Groq.
 *
 * Kept as an alternative to AutoRepairGUI for environments without a
 * display, or for anyone who prefers a terminal workflow.
 */
